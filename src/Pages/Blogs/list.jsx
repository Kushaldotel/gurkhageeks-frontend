                ...
                <div className="flex flex-col md:flex-row bg-white overflow-hidden">
                  ...
                  <div className="md:w-1/2 sm:px-6 py-4 ">
                    <div className="space-y-4">
                      <p className="border p-1.5 inline tracking-normal border-gray-800 rounded-sm">
...
// const BlogCard = React.memo(({ blog, layout }) => {
...
//     return (
//       <div className="flex flex-col md:flex-row bg-white overflow-hidden max-w-7xl mx-auto p-4 md:p-6 lg:p-8 xl:px-0">
//         <div className="md:w-1/2">
//           <img
//             src={blog.thumbnail || "/img/AI.jpg"}
//             alt="Blog Post Image"
...
//           />
//         </div>
//         <div className="md:w-1/2 sm:px-6 py-4 space-y-4">
...
//           />
//           <div className="flex items-center space-x-3">
//             <img src="/img/icons.png" className="h-7 w-7 p-0.5 border border-gray-200 rounded-full" alt="Author" />
//             <div>
//               <p className="font-medium">{blog.authorName || "Adarsh Thapa"}</p>
//               <p className="text-muted-foreground text-sm">
...
//       <div className="h-48 overflow-hidden">
//         <img src={blog.thumbnail || "/img/FullStack.png"} alt="Blog Post Image" className="w-full h-full object-cover" />
//       </div>
//       <div className="p-6 flex-grow flex flex-col">
...
//   const { data: allBlogs, loading: blogsLoading } = useFetch(`${BASE_URL}/blog/`, "blogs");
//   const { data: categories, loading: categoriesLoading } = useFetch(`${BASE_URL}/blog/categories/`, "categories");

//   const filteredBlogs = useMemo(() => {
//     if (!currentCategory) return allBlogs;
//     return allBlogs.filter(blog => blog.categories.some(cat => cat.id === currentCategory));
//   }, [allBlogs, currentCategory]);

//   const toggleLayout = useCallback((layout) => {
//     setCurrentLayout(layout);
//     setLayoutOpen(false);
//   }, []);
...
//     <div className="min-h-screen">
//       <header className="py-4 p-4 sm:flex items-center justify-between max-w-7xl mx-auto md:p-6 lg:px-8 xl:px-0">
//         <h1 className="text-2xl font-bold text-gray-800 py-4 sm:p-0">All Blogs</h1>
//         <div className="flex space-x-8">
//           <div className="relative">
//             <button
//               onClick={() => setIsOpen(!isOpen)}
...
//               className="flex items-center gap-3 border border-gray-500 rounded-sm px-3 py-2 text-gray-700"
//             >
//               <img src="/img/layout.png" alt="Layout Options" className="h-4 w-4 sm:h-5 sm:w-5" />
//               <span className="text-xs sm:text-sm font-medium">Layouts</span>
//             </button>
//             {layoutOpen && (
//               <div className="absolute right-0 mt-2 w-40 bg-white shadow-sm rounded-sm z-10 border border-gray-400">
//                 <div className="px-4 py-2 text-gray-500 font-semibold">Layouts</div>
//                 <div className="border-gray-200">
//                   <button
//                     onClick={() => toggleLayout("horizontal")}
//                     className={`block px-4 py-2 text-gray-700 hover:bg-gray-100 w-full text-left ${
...
//         <div className="text-center text-gray-600 mt-20">No blog posted yet.</div>
//       ) : (
//         <div className={currentLayout === "horizontal" ? "flex flex-wrap justify-center" : "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto py-6"}>
//           {filteredBlogs.map((blog) => (
//             <BlogCard key={blog.id} blog={blog} layout={currentLayout} />
//           ))}
//         </div>
//       )}
//     </div>
